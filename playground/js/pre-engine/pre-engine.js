define(['jquery',
        'mustache',
        'text!../pre-engine/html/templates.html',
        'i18n!../pre-engine/nls/translate',
        'd3',
        'bootstrap'], function ($, Mustache, templates, translate, d3) {
    ...
    PRE_ENGINE.prototype.init = function(config) {
        ...
        this.create_test_tree();

    };

    PRE_ENGINE.prototype.create_test_tree = function () {
        var width = 750;
        var height = 750;
        var diameter = 750;
        var tree = d3.layout.tree().size([360, diameter / 2 - 120]).separation(function (a, b) {
